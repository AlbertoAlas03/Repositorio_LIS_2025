                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])):
                            ...
                            extract($_POST);
                            $cliente = !empty($client) ? $client : "<a href= 'formulario.html' class='text-danger'>No ingreso el nombre del cliente</a>";
                            echo "\t\t<td>" . $cliente . "</td>\n";
                            echo "\t</tr>\n";
                            echo "\t<tr>\n";
                            echo "\t\t<td>Producto</td>\n";
                            $producto = !empty($product) ? $product : "<a href='formulario.html' class='text-danger'>No ingresó el nombre del producto.</a>";
                            echo "\t\t<td>" . $producto . "</td>\n";
                            echo "\t</tr>\n";
                            echo "\t<tr>\n";
                            echo "\t\t<td>Precio</td>\n";
                            $precio = !empty($price) ? $price : "<a href='formulario.html' class='text-danger'>No ingresó el precio del producto</a>";
                            echo "\t\t<td>" . $precio . "</td>\n";
                            echo "\t</tr>\n";
                            echo "\t<tr>\n";
                            echo "\t\t<td>Cantidad</td>\n";
                            $cantidad = !empty($quantity) ? $quantity : "<a href='formulario.html' class='text-danger'>No
...
formulario.</td>\n";
                ...
                <div id="link" class="text-center mt-4">
                    <a href="formulario.html" class="btn btn-primary">Ingresar nuevos datos</a>
                </div>
            </div>
        </article>
    </section>
