    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-md-7">
                ...
                ?>
                <form role="form" action="<?= PATH ?> /Editoriales/insert" method="POST"> <!-- Colocamos la cadena constante para nuestra peticion-->
                    <div class="mb-3">
                        <label for="codigo" class="form-label">Código del Editorial:</label>
                        <input type="text" class="form-control" name="codigo_editorial" id="codigo_editorial" value="<?= empty($editorial['codigo_editorial'])?'':$editorial['codigo_editorial']?>" placeholder="Ingresa el código del editorial">
                    </div>
                    <div class="mb-3">
