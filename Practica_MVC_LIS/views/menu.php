      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="autoresDropdown">
            ...
            <li><a class="dropdown-item" href="<?= PATH ?>/Autores/index">Ver lista de autores</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="editorialesDropdown">
            ...
            <li><a class="dropdown-item" href="<?= PATH ?>/Editoriales/index">Ver lista de editoriales</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
